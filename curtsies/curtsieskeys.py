...
CURTSIES_NAMES = dict(
    [
        ...
        (
            b"\x1bOA",
            u"<UP>",
        ),  # in issue 92 its shown these should be normal arrows,
        ...
        (
            b"\x1b[5A",
            u"<Ctrl-UP>",
        ),  # not sure about these, someone wanted them for bpython
        ...
        (
            b"\x7f",
            u"<BACKSPACE>",
        ),  # for some folks this is ctrl-backspace apparently
